...
network_course = [
    ['Cisco CCNA Certification', 'https://www.coursera.org/learn/ccna'],
    ['Network Security Basics', 'https://www.udemy.com/course/network-security/'],
    ['Introduction to Networking', 'https://www.edx.org/course/introduction-to-computer-networking']
]

database_course = [
    ['SQL for Data Science', 'https://www.coursera.org/learn/sql-for-data-science'],
    ['Oracle PL/SQL Fundamentals', 'https://www.udemy.com/course/oracle-sql-plsql/'],
    ['Database Design', 'https://www.edx.org/course/database-systems']
]

cloud_course = [
    ['AWS Certified Solutions Architect', 'https://www.coursera.org/learn/aws-fundamentals'],
    ['Google Cloud Fundamentals', 'https://www.coursera.org/specializations/gcp-fundamentals'],
    ['Microsoft Azure Essentials', 'https://learn.microsoft.com/en-us/training/']
]

devops_course = [
    ['CI/CD with Jenkins', 'https://www.udemy.com/course/jenkins-from-zero-to-hero/'],
    ['Docker Mastery', 'https://www.udemy.com/course/docker-mastery/'],
    ['Kubernetes for Beginners', 'https://www.coursera.org/learn/google-kubernetes-engine']
]
